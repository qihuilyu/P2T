...
phantom_DECT = ones(nx,ny,nz)*airHU;
mask0 = ((x-(1+nx)/2).^2/(60.^2)+(y-(1+ny)/2).^2/(50.^2)<1 & z<80 & z>20);
phantom_DECT(mask0) = waterHU;
figure;imshow3D(phantom_DECT,[-1000,1600])
...
mathu   = [-1024,0,1518,50805,52186,53568,54949,56330,57712,59093];
...
% matdenslist = [ 6.7000    6.8000    6.9000    7.0000    7.1000    7.2000       7.3];
...
mkdir('D:\datatest\PairProd\phantom_DECT\')
save('D:\datatest\PairProd\phantom_DECT\phantom_DECT.mat','phantom_DECT','BODY')
