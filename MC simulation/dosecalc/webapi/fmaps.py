...
class Beam:
    ...
    def __init__(self, wts, gantry=0, couch=0, coll=0, iso=(0,0,0), sad=100, beamlet_size=(0.5, 0.5), beamlet_spacing=(0.5, 0.5), gantry_deg=None, couch_deg=None, coll_deg=None):
        self.wts = wts
        ...
        self.beamlet_spacing = beamlet_spacing
    ...
    def __str__(self):
        return  'Beam:\n' +\
                ...
                '  beamlet_spacing: {:0.2f}x{:0.2f} [cm]\n'.format(*self.beamlet_spacing) +\
...
class Fmaps:
    ...
    def generate(self, fname):
        with h5py.File(fname, 'w') as h5fd:
            ...
            ftgroup.attrs.create("ftversionminor", 2, dtype='uint8')
