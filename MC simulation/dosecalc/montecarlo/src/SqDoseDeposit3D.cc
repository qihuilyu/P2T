...
//
//
// $Id: SqDoseDeposit3D.cc 67992 2013-03-13 10:59:57Z gcosmo $
//
// SqDoseDeposit3D
#include "SqDoseDeposit3D.hh"
...
SqDoseDeposit3D::SqDoseDeposit3D(G4String name,
...
SqDoseDeposit3D::~SqDoseDeposit3D()
{;}

G4int SqDoseDeposit3D::GetIndex(G4Step* aStep)
{
...
if(i<0||j<0||k<0)
{
  ...
  G4Exception("SqDoseDeposit3D::GetIndex","DetPS0005",JustWarning,ED);
}
