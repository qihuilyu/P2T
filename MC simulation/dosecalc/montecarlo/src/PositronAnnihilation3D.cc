...
//
//
// $Id: PositronAnnihilation3D.cc 67992 2013-03-13 10:59:57Z gcosmo $
//
// PositronAnnihilation3D
...
PositronAnnihilation3D::PositronAnnihilation3D(G4String name,
				     G4int ni, G4int nj, G4int nk,
				     G4int di, G4int dj, G4int dk)
    :PositronAnnihilation(name),
...
PositronAnnihilation3D::~PositronAnnihilation3D()
{;}

G4int PositronAnnihilation3D::GetIndex(G4Step* aStep)
{
...
if(i<0||j<0||k<0)
{
  ...
  G4Exception("PositronAnnihilation3D::GetIndex","DetPS0005",JustWarning,ED);
}
